...
clear
echo ""
echo -e "Welcome To 15_tool-XB" | lolcat
echo ""

echo -e "\e[102m Press Enter \e[0m"
read a1
...
echo "-------------------------------------------------------" | lolcat
echo   "Author   : 15_tool-XB $white" |lolcat
echo   "Contact  : https://t.me/Linuxxb $white" |lolcat
echo   "YouTube  : TECH COCHI $white" |lolcat
echo   "YouTube  : https://youtude.com/@LinuxXB$white" |lolcat
echo "-------------------------------------------------------" | lolcat
echo "                           v1.0              " | lolcat
###################################################
# CTRL + C
...
00) echo "created by : 15_tool-XB" | lolcat
exit
;;
